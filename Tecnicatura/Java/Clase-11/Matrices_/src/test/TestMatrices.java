...
//        }
        ...
        personas[0][0] = new Persona("Toribia");
        personas[0][1] = new Persona("Sanchez");
        personas[0][2] = new Persona("Mangacha");
        personas[1][0] = new Persona("Toicha");
        personas[1][1] = new Persona("Eustaquio");
        personas[1][2] = new Persona("Eusebio");
