...
const experiencia = ref([
  {fecha: '2024 - Actual', title: 'Desarrollador Web en Refindable', descripcion: 'Desarrollo de páginas web con WordPress & Shopify empleando HTML, CSS y JavaScript personalizados para optimizar la visualización y las funcionalidades recomendadas para UX. Implementación desde diseños hechos en Adobe XD y Figma.Soporte y mantenimiento web, ánalisis y troubleshooting para resolver problemas complejos.'},
  {fecha: '2022 - 2024', title: 'Desarrolador WordPress en AccelOne', descripcion: 'Desarrollo de páginas web desde Figma mediante plantillas en WordPress, plugins, HTML5, CSS y JS. Uso de diferentes web builders y plantillas personalizadas hechas con PHP. Trabajo en equipo para la resolución de problemas de visualización, interacción, navegación y experiencia del sitio web. Optimización de rendimiento y funcionalidad.'},
  {fecha: '2019 - 2021', title: 'Especialista SEO y Desarrollo Web con AEM en Cheil - Samsung SEASA', descripcion: 'SEO: Análisis y desarrollo de estrategias de SEO para mejorar el rendimiento del sitio ecommerce. Investigación de las oportunidades del mercado local, mediate el tráfico, rankings , conversiones y datos off-site. Optimización on-site y revisión de las mejores prácticas UX para el sitio. Web Publisher: Administración del sitio web institucional para Argentina, Paraguay y Uruguay. Creación y revisión UX de las páginas existentes. Implementación de pixeles de seguimiento.'},
  {fecha: '2016 - 2019', title: 'Team Leader en Cognizant - Google Ads', descripcion: 'Líder del equipo de nuevos ingresos y del equipo de atención por chat. Seguimiento individual y grupal, desarrollo de estrategias para alcanzar los objetivos del proyecto. Trainer: capacitador de las plataformas de Google y del proyecto. Subject Matter Expert: resolución de consultas internas de los agentes de la operación. Online Specialist: asesoría por teléfono, email y chat de las plataformas Google Ads, Analytics, Merchant Center, Tag Manager para LATAM. Optimización y estrategias de marketing de cuentas high value.'}
...
<template>
    <ul>
        <li v-for="(item, index) in experiencia" :key="index" :style="{ '--fecha-color': fechaColor[index].color}">
...
ul {
  ...
  width: min(60rem, 98%); /* Limita el ancho de la lista al mínimo entre 60rem y el 90% del ancho de la ventana */
