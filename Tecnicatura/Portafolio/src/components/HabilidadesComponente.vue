...
const habilidades = ref([
    ...
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            { id: 1, nombre: 'Vue.js', nivel: 'Intermedio', icono: img7 },
            { id: 2, nombre: 'Bootstrap', nivel: 'Avanzado', icono: img10 }
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'CMS', nivel: 'Avanzado', icono: img11 },
            { id: 2, nombre: 'WordPress', nivel: 'Avanzado', icono: img11 },
            { id: 3, nombre: 'Shopify', nivel: 'Avanzado', icono: img11 },
            { id: 4, nombre: 'Git', nivel: 'Avanzado', icono: img11 },
            { id: 5, nombre: 'Jira', nivel: 'Avanzado', icono: img12 },
            { id: 6, nombre: 'Figma', nivel: 'Intermedio', icono: img14 },
            { id: 7, nombre: 'Visual Studio Code', nivel: 'Avanzado', icono: img15 }
        ]
    },
    {
...
.skills-contenedor {
    ...
    /*Fondo con gradiente*/
    background: linear-gradient(-45deg, #283618, #606c38, #606c38);
...
.skill {
    ...
    padding: 0.3em;
    border-radius: 8px;
    box-shadow: 0px 4px 12px #283618;
    flex: 1 1 200px;
    max-width: 250px;
